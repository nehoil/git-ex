...
function getAllPossibleCoordsKing(pieceCoord) { // {i:2, j:3}
    var res = [];
    var pos = pieceCoord
...
// var test = countNgs(gBoard, {i:2, j:3})
// countNgs(gBoard, gPos)
// console.log(test);
...
// var gPos = { i: 0, j: 3 }
// function countNgs(gBoard, pos) {
//     var res = [];
//     for (var i = pos.i - 1; i <= pos.i + 1; i++) {
//         if (i < 0 || i >= gBoard.length) continue;
//         var rowIdx = pos.i - 1;
//         for (var j = pos.j - 1; j <= pos.j + 1; j++) {
//             var coord = { i: rowIdx--, j: j };
//             if (j < 0 || j >= gBoard[i].length) continue;
//             if (i === pos.i && j === pos.j) continue;
